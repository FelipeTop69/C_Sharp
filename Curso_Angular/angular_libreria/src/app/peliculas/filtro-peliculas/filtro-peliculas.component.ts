...
export class FiltroPeliculasComponent implements OnInit {
    ngOnInit(): void {
      ...
      this.form.valueChanges.subscribe(valores => {
        ...
        this.escribirParametrosDeBusquedaEnURL(valores as FiltroPeliculas)
      })
    }
    ...
    escribirParametrosDeBusquedaEnURL(valores: FiltroPeliculas){
      let queryStrings = []
    ...
    form = this.formBuilder.group({
      // Se asignan valores pq se va tratar de un fitro por lo que deben haber valores por default
      titulo: '',
      generoId: 0,
      proximosEstrenos: false,
      enCines: false,
    ...
    genero = [
      ...
      {generoId: 2, nombre: 'Accion'},
      {generoId: 3, nombre: 'Misterio'},
    ]
